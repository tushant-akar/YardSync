...
class RecordsAdapter(
    ...
    inner class ViewHolder(private val binding: ExpandableCardItemBinding) :
        ...
        fun bind(vehicle: Vehicle) {
            ...
            binding.card.setOnClickListener {
                if (isExpanded) {
                    val collapseAnim =
                        AnimationUtils.loadAnimation(binding.root.context, R.anim.collapse)
                    ...
                    val expandAnim =
                        AnimationUtils.loadAnimation(binding.root.context, R.anim.expand)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            ExpandableCardItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
